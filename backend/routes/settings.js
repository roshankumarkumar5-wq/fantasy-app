...
// users' "Players" leaderboard tab, or whether other teams may be viewed
// once a match is locked). Falls back to defaults if the table doesn't
// exist yet (migration not run) so nothing breaks.
